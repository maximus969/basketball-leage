...
import { deletePlayerTC, getPlayerInfoTC } from "../modules/players/playersThunk"
...
export const PlayerInfo: FC = () => {
  ...
  useEffect(() => {
    dispatch(getPlayerInfoTC(Number(id)))
  }, [])

  const deletePlayerHandler = () => {
    dispatch(deletePlayerTC(Number(id)))
    navigate(-1)
  }
  const updatePlayer = () => {
    ...
    <div className={wrapper.mainContent}>
      <div className={styles.mainContainer}>
        <div className={`${styles.container} ${styles.playerContainer}`}>
          ...
          <div className={`${styles.teamInfoContainer} ${styles.playerInfoContainer}`}>
            ...
            <div className={styles.textInfoBlock}>
              <div className={styles.textInfo}>
                ...
                <div className={styles.description}>
                  <div className={styles.descriptionPlayerBlock}>
