...
import { addPlayerTC } from "../modules/players/playersThunk"
...
export const AddPlayer: FC = () => {
  ...
  const onSubmit = (formData: IFormInputs) => {
    const birthday = new Date(formData.birthday.split('-').reverse().join('-')).toISOString()
    dispatch(addPlayerTC(
      { ...formData, avatarUrl: newImageUrl, birthday }
    ))
